...
class FusedGateMLP(nn.Module):
    ...
    def apply_gmm(
        ...
        **kwargs: Any,
        ...
        from taktiny.cosette.kernels.megablox import gmm
    ...
    def apply_route(
        ...
        **kwargs: Any,
        ...
        from taktiny.cosette.kernels.sort_activations import route
    ...
    def apply_unroute(
        ...
        **kwargs: Any,
        ...
        from taktiny.cosette.kernels.sort_activations import unroute
        indices_2d = indices[:, None] if indices.ndim == 1 else indices
