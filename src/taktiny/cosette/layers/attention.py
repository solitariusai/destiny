...
class AttentionLegacy(nn.Module):
    ...
    def apply_flash_attention(
        ...
        **kwargs: tp.Any,
        ...
        from taktiny.cosette.kernels.attention.flash_attention import flash_attention_block_masked
        (
            batch_size,
            query_length,
            key_length,
    ...
    def apply_splash_attention(
        ...
        **kwargs: tp.Any,
        ...
        from taktiny.cosette.kernels.attention.splash_attention import attention_reference
